...
#define MOUSE_BUTTON_RIGHT 2
	...
	void WinRTInputManager::OnKeyDownOrUp(winrt::Windows::UI::Core::KeyEventArgs const& args, bool kenDown)
	{
		...
		{
			//TODO
			keyboardKeys[BRLS_KBD_KEY_LEFT_ALT]=altState?BTN_PRESSED:BTN_STICKY;
			return;
		}
		keyboardKeys[code]=kenDown?BTN_PRESSED:BTN_STICKY;
