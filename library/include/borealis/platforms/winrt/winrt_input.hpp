...
class WinRTInputManager : public InputManager
{
  public:
    ...
    void updateControllerSensorsUpdate();

    void updateKeyboardState(winrt::Windows::UI::Core::KeyEventArgs const& event);
  ...
  private:
    ...
    void PointerReleased(winrt::Windows::Foundation::IInspectable const&, winrt::Windows::UI::Core::PointerEventArgs const& args);
